...
CREATE TABLE IF NOT EXISTS FILMS_DIRECTORS (
    ...
    CONSTRAINT FILMS_DIRECTORS_FILMS_FK FOREIGN KEY (FILM_ID) REFERENCES FILMS(ID) ON DELETE CASCADE,
    CONSTRAINT FILMS_DIRECTORS_DIRECTORS_FK FOREIGN KEY (DIRECTOR_ID) REFERENCES DIRECTORS(ID) ON DELETE CASCADE,
